...
document.write('</div>');
document.write('<button class="btn btn-secondary my-3" style="width: 100%;">Proceed to Pay</button>');
document.write('<div class="form-check">');
document.write('<input class="form-check-input" type="checkbox" name="pp-agree" value="1">');
