...
if (cartArray.length === 0) {
    ...
    for (let item in cartArray) {
        ...
        document.write('</div>');
        document.write('<div class="col-md-5 align-self-center py-4 text-center text-md-start">');
        ...
        document.write('<div class="d-flex justify-content-center justify-content-md-start qty-selector input-group">');
        ...
        document.write('</div>');
        document.write('</div>');
        document.write('<div class="col-md-1 align-self-top ps-4 text-center text-md-start">');
